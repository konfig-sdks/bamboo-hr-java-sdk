...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.bamboohr.com/api/gateway.php";
    private String tokenUrl = "https://{companyDomain}.bamboohr.com/token.php";
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        authentications.put("auth", oauth);
        return oauth;
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.bamboohr.com/api/gateway.php)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g https://{companyDomain}.bamboohr.com/token.php)
     * @return An instance of OkHttpClient
     */
