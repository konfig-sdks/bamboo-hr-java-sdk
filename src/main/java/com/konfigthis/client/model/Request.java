...
public class Request {
  ...
  **/
  ...
  @ApiModelProperty(example = "Approved", value = "One of approved, cancelled, denied")
  ...
  public Request note(String note) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Note!", value = "A note to attach to the change in status")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, request.status) &&
        Objects.equals(this.note, request.note)&&
        Objects.equals(this.additionalProperties, request.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, note, additionalProperties);
  }
