...
public class BenefitsAddNewCompanyBenefitRequest {
 ...
 public enum ReimbursementFrequencyEnum {
  ...
  public BenefitsAddNewCompanyBenefitRequest() {
  }

  public BenefitsAddNewCompanyBenefitRequest description(String description) {
  ...
  **/
  ...
  public BenefitsAddNewCompanyBenefitRequest companyBenefitName(String companyBenefitName) {
  ...
  **/
  ...
  public BenefitsAddNewCompanyBenefitRequest benefitVendorId(String benefitVendorId) {
  ...
  **/
  ...
  public BenefitsAddNewCompanyBenefitRequest benefitType(BenefitTypeEnum benefitType) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Benefit type")
  ...
  public BenefitsAddNewCompanyBenefitRequest deductionTypeId(String deductionTypeId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Deduction type ID")
  ...
  public BenefitsAddNewCompanyBenefitRequest startDate(LocalDate startDate) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Benefit start date")
  ...
  public BenefitsAddNewCompanyBenefitRequest endDate(LocalDate endDate) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Benefit end date")
  ...
  public BenefitsAddNewCompanyBenefitRequest planUrl(String planUrl) {
  ...
  **/
  ...
  public BenefitsAddNewCompanyBenefitRequest ssoLoginUrl(String ssoLoginUrl) {
  ...
  **/
  ...
  public BenefitsAddNewCompanyBenefitRequest ssoLoginUrlLinkText(String ssoLoginUrlLinkText) {
  ...
  **/
  ...
  public BenefitsAddNewCompanyBenefitRequest safeHarbor(Boolean safeHarbor) {
  ...
  **/
  ...
  public BenefitsAddNewCompanyBenefitRequest meetAcaMin(Boolean meetAcaMin) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Meets ACA minimum requirements")
  ...
  public BenefitsAddNewCompanyBenefitRequest reimbursementAmount(Double reimbursementAmount) {
  ...
  public BenefitsAddNewCompanyBenefitRequest reimbursementAmount(Integer reimbursementAmount) {
  ...
  **/
  ...
  public BenefitsAddNewCompanyBenefitRequest reimbursementFrequency(ReimbursementFrequencyEnum reimbursementFrequency) {
  ...
  **/
  ...
  public BenefitsAddNewCompanyBenefitRequest reimbursementCurrencyCode(String reimbursementCurrencyCode) {
  ...
  **/
  ...
  public BenefitsAddNewCompanyBenefitRequest minEssentialCoverage(Boolean minEssentialCoverage) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Provides minimum essential coverage")
   ...
   * @return the BenefitsAddNewCompanyBenefitRequest instance itself
   */
  public BenefitsAddNewCompanyBenefitRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BenefitsAddNewCompanyBenefitRequest benefitsAddNewCompanyBenefitRequest = (BenefitsAddNewCompanyBenefitRequest) o;
    return Objects.equals(this.description, benefitsAddNewCompanyBenefitRequest.description) &&
        Objects.equals(this.companyBenefitName, benefitsAddNewCompanyBenefitRequest.companyBenefitName) &&
        Objects.equals(this.benefitVendorId, benefitsAddNewCompanyBenefitRequest.benefitVendorId) &&
        Objects.equals(this.benefitType, benefitsAddNewCompanyBenefitRequest.benefitType) &&
        Objects.equals(this.deductionTypeId, benefitsAddNewCompanyBenefitRequest.deductionTypeId) &&
        Objects.equals(this.startDate, benefitsAddNewCompanyBenefitRequest.startDate) &&
        Objects.equals(this.endDate, benefitsAddNewCompanyBenefitRequest.endDate) &&
        Objects.equals(this.planUrl, benefitsAddNewCompanyBenefitRequest.planUrl) &&
        Objects.equals(this.ssoLoginUrl, benefitsAddNewCompanyBenefitRequest.ssoLoginUrl) &&
        Objects.equals(this.ssoLoginUrlLinkText, benefitsAddNewCompanyBenefitRequest.ssoLoginUrlLinkText) &&
        Objects.equals(this.safeHarbor, benefitsAddNewCompanyBenefitRequest.safeHarbor) &&
        Objects.equals(this.meetAcaMin, benefitsAddNewCompanyBenefitRequest.meetAcaMin) &&
        Objects.equals(this.reimbursementAmount, benefitsAddNewCompanyBenefitRequest.reimbursementAmount) &&
        Objects.equals(this.reimbursementFrequency, benefitsAddNewCompanyBenefitRequest.reimbursementFrequency) &&
        Objects.equals(this.reimbursementCurrencyCode, benefitsAddNewCompanyBenefitRequest.reimbursementCurrencyCode) &&
        Objects.equals(this.minEssentialCoverage, benefitsAddNewCompanyBenefitRequest.minEssentialCoverage)&&
        Objects.equals(this.additionalProperties, benefitsAddNewCompanyBenefitRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BenefitsAddNewCompanyBenefitRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("benefitType");
    openapiRequiredFields.add("deductionTypeId");
    openapiRequiredFields.add("startDate");
    openapiRequiredFields.add("endDate");
    openapiRequiredFields.add("meetAcaMin");
    openapiRequiredFields.add("minEssentialCoverage");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BenefitsAddNewCompanyBenefitRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BenefitsAddNewCompanyBenefitRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BenefitsAddNewCompanyBenefitRequest is not found in the empty JSON string", BenefitsAddNewCompanyBenefitRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BenefitsAddNewCompanyBenefitRequest.openapiRequiredFields) {
      ...
      if (!jsonObj.get("benefitType").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BenefitsAddNewCompanyBenefitRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BenefitsAddNewCompanyBenefitRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BenefitsAddNewCompanyBenefitRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BenefitsAddNewCompanyBenefitRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BenefitsAddNewCompanyBenefitRequest>() {
           @Override
           public void write(JsonWriter out, BenefitsAddNewCompanyBenefitRequest value) throws IOException {
           ...
           @Override
           public BenefitsAddNewCompanyBenefitRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BenefitsAddNewCompanyBenefitRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BenefitsAddNewCompanyBenefitRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BenefitsAddNewCompanyBenefitRequest
  * @throws IOException if the JSON string is invalid with respect to BenefitsAddNewCompanyBenefitRequest
  */
  public static BenefitsAddNewCompanyBenefitRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BenefitsAddNewCompanyBenefitRequest.class);
  }

 /**
  * Convert an instance of BenefitsAddNewCompanyBenefitRequest to an JSON string
  *
  * @return JSON string
  */
