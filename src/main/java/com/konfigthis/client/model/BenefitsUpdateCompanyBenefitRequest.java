...
public class BenefitsUpdateCompanyBenefitRequest {
 ...
 public enum ReimbursementFrequencyEnum {
  ...
  public BenefitsUpdateCompanyBenefitRequest() {
  }

  public BenefitsUpdateCompanyBenefitRequest description(String description) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest companyBenefitName(String companyBenefitName) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest benefitVendorId(String benefitVendorId) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest benefitType(BenefitTypeEnum benefitType) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest deductionTypeId(String deductionTypeId) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest startDate(LocalDate startDate) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest endDate(LocalDate endDate) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest planUrl(String planUrl) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest ssoLoginUrl(String ssoLoginUrl) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest ssoLoginUrlLinkText(String ssoLoginUrlLinkText) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest safeHarbor(Boolean safeHarbor) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest meetAcaMin(Boolean meetAcaMin) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest reimbursementAmount(Double reimbursementAmount) {
  ...
  public BenefitsUpdateCompanyBenefitRequest reimbursementAmount(Integer reimbursementAmount) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest reimbursementFrequency(ReimbursementFrequencyEnum reimbursementFrequency) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest reimbursementCurrencyCode(String reimbursementCurrencyCode) {
  ...
  **/
  ...
  public BenefitsUpdateCompanyBenefitRequest minEssentialCoverage(Boolean minEssentialCoverage) {
  ...
  **/
   ...
   * @return the BenefitsUpdateCompanyBenefitRequest instance itself
   */
  public BenefitsUpdateCompanyBenefitRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BenefitsUpdateCompanyBenefitRequest benefitsUpdateCompanyBenefitRequest = (BenefitsUpdateCompanyBenefitRequest) o;
    return Objects.equals(this.description, benefitsUpdateCompanyBenefitRequest.description) &&
        Objects.equals(this.companyBenefitName, benefitsUpdateCompanyBenefitRequest.companyBenefitName) &&
        Objects.equals(this.benefitVendorId, benefitsUpdateCompanyBenefitRequest.benefitVendorId) &&
        Objects.equals(this.benefitType, benefitsUpdateCompanyBenefitRequest.benefitType) &&
        Objects.equals(this.deductionTypeId, benefitsUpdateCompanyBenefitRequest.deductionTypeId) &&
        Objects.equals(this.startDate, benefitsUpdateCompanyBenefitRequest.startDate) &&
        Objects.equals(this.endDate, benefitsUpdateCompanyBenefitRequest.endDate) &&
        Objects.equals(this.planUrl, benefitsUpdateCompanyBenefitRequest.planUrl) &&
        Objects.equals(this.ssoLoginUrl, benefitsUpdateCompanyBenefitRequest.ssoLoginUrl) &&
        Objects.equals(this.ssoLoginUrlLinkText, benefitsUpdateCompanyBenefitRequest.ssoLoginUrlLinkText) &&
        Objects.equals(this.safeHarbor, benefitsUpdateCompanyBenefitRequest.safeHarbor) &&
        Objects.equals(this.meetAcaMin, benefitsUpdateCompanyBenefitRequest.meetAcaMin) &&
        Objects.equals(this.reimbursementAmount, benefitsUpdateCompanyBenefitRequest.reimbursementAmount) &&
        Objects.equals(this.reimbursementFrequency, benefitsUpdateCompanyBenefitRequest.reimbursementFrequency) &&
        Objects.equals(this.reimbursementCurrencyCode, benefitsUpdateCompanyBenefitRequest.reimbursementCurrencyCode) &&
        Objects.equals(this.minEssentialCoverage, benefitsUpdateCompanyBenefitRequest.minEssentialCoverage)&&
        Objects.equals(this.additionalProperties, benefitsUpdateCompanyBenefitRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BenefitsUpdateCompanyBenefitRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BenefitsUpdateCompanyBenefitRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BenefitsUpdateCompanyBenefitRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BenefitsUpdateCompanyBenefitRequest is not found in the empty JSON string", BenefitsUpdateCompanyBenefitRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BenefitsUpdateCompanyBenefitRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BenefitsUpdateCompanyBenefitRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BenefitsUpdateCompanyBenefitRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BenefitsUpdateCompanyBenefitRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BenefitsUpdateCompanyBenefitRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BenefitsUpdateCompanyBenefitRequest>() {
           @Override
           public void write(JsonWriter out, BenefitsUpdateCompanyBenefitRequest value) throws IOException {
           ...
           @Override
           public BenefitsUpdateCompanyBenefitRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BenefitsUpdateCompanyBenefitRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BenefitsUpdateCompanyBenefitRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BenefitsUpdateCompanyBenefitRequest
  * @throws IOException if the JSON string is invalid with respect to BenefitsUpdateCompanyBenefitRequest
  */
  public static BenefitsUpdateCompanyBenefitRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BenefitsUpdateCompanyBenefitRequest.class);
  }

 /**
  * Convert an instance of BenefitsUpdateCompanyBenefitRequest to an JSON string
  *
  * @return JSON string
  */
